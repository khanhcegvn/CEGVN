...
namespace CEGVN.TVD
{
	internal class RebarSymbolCreatorController : RvtController
	{
		...
		public override void Execute()
		{
			...
			{
				foreach (KeyValuePair<string, FamilyInstance> pair in this.Dic)
				{
		...
		public override void ReadData()
		{
			...
			if (!flag)
			{
				ViewSchedule viewSchedule = base.Doc.GetElement(scheduleSheetInstance.ScheduleId) as ViewSchedule;
